...
<%		
		...
		for(int j=8;j<columnList.size();j+=8){
				...
				start5181.x = (Math.round(start5181.x));
				start5181.y = (Math.round(start5181.y));
				arrive5181.x = (Math.round(arrive5181.x));
				arrive5181.y = (Math.round(arrive5181.y));
				// 다음에서 json 받아오는 부분	
				URL daumReq = new URL("http://map.daum.net/route/carset.json?roadside=ON&carMode="+searchTypeD+"&carOption="+carOption+"&sX="+start5181.x+"&sY="+start5181.y+"&eX="+arrive5181.x+"&eY="+arrive5181.y+"");
				...
				if(JSONObject.toJSONString(jObj)=="null"){
					...
					daumReq = new URL("http://map.daum.net/route/carset.json?roadside=ON&carMode="+searchTypeD+"&carOption="+carOption+"&sX="+start5181.x+"&sY="+start5181.y+"&eX="+arrive5181.x+"&eY="+arrive5181.y+"");
